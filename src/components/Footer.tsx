  ...
  return (
    <footer className="bg-atlantico-escuro text-branco/70">
      <div className="mx-auto max-w-6xl px-5 md:px-8 py-10 flex flex-col md:flex-row justify-between gap-6 text-sm">
        <div>
          <p className="font-display text-branco text-lg">Pousada Nossa Senhora de Fátima</p>
        ...
        <div className="flex flex-col gap-1">
          ...
          <a href="mailto:contato@pousadefatima.com.br" className="hover:text-branco transition-colors">
            contato@pousadefatima.com.br
          </a>
      ...
      <div className="border-t border-branco/10 py-4 text-center text-xs text-branco/40">
        © {new Date().getFullYear()} Pousada Nossa Senhora de Fátima
      </div>
    </footer>
  );
}
